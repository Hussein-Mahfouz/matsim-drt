...
# Output demand
demand_matsim = read_delim("../scenarios/fleet_sizing/all/1000/sample_1.00/eqasim_trips.csv", delim =";")
# demand_matsim = read_delim("../scenarios/fleet_sizing/zones/1000/sample_1.00/eqasim_trips.csv", delim =";")
...
ggplot(data = demand_compare_summary, aes(axis1 = input_mode, axis2 = output_mode, y = trips)) +
  ...
  ggrepel::geom_text_repel(
    ...
    stat = "stratum", size = 4, direction = "y", nudge_x = .25
  ) +
