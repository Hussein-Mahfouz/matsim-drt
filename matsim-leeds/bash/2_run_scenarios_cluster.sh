...
GLOBAL_THREADS=12
QSIM_THREADS=12
SPECIFIED_GLOBAL_THREADS=12
# Should not be higher than CPUS_PER_TASK
GLOBAL_THREADS=$(( CPUS_PER_TASK < SPECIFIED_GLOBAL_THREADS ? CPUS_PER_TASK : SPECIFIED_GLOBAL_THREADS ))
SPECIFIED_QSIM_THREADS=12
# Should not be higher than CPUS_PER_TASK
QSIM_THREADS=$(( CPUS_PER_TASK < SPECIFIED_QSIM_THREADS ? CPUS_PER_TASK : SPECIFIED_QSIM_THREADS ))
