...
for FLEET_SIZE in "${fleet_sizes[@]}"; do
    ...
    declare -a argsArray=(
        ...
        "matsim-leeds/data/supply/drt/nw/fleets/drt_fleet_nw_${FLEET_SIZE}.xml,matsim-leeds/data/supply/drt/ne/fleets/drt_fleet_ne_${FLEET_SIZE}.xml \
        drtNW,drtNE \
    ...
    #     "matsim-leeds/data/supply/drt/all/fleets/drt_fleet_all_${FLEET_SIZE}.xml \
    #     drt \
    #     door2door \
    #     true \
    #     LeedsDrtCostModel \
